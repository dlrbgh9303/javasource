...
public class Account3 {
	...
	// 출금한다.(입력값 : 출금액, 반환값 현재잔액)    현재잔액 -= 출금액
		public Account3(String accNum, int balance, String name) {
//			super();
			this.balance = balance;
//			this.accNum = accNum;
//			this.name = name;
			this(accNum,name); // this() : 다른 생성자 호출
		...
		public Account3(String accNum, String name) {
			super();
			this.accNum = accNum;
			this.name = name;
		}
